...
# import absolute import to avoid circular ref between pywbem_server,
# connection_repository and pywbemcli_operations.
from ._connection_file_names import DEFAULT_CONNECTIONS_FILE, \
    MOCKCACHE_ROOT_DIR
# from pywbemtools.pywbemcli._connection_file_names \
#     import DEFAULT_CONNECTIONS_FILE, MOCKCACHE_ROOT_DIR
