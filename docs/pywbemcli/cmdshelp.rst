...
::
    ...
    Command Options:
      -f, --set-default  Set this definition as the default definition. That connection will be loaded upon pywbemcli
                         startup if no server or name is included on the command line.
      -h, --help         Show this help message.
