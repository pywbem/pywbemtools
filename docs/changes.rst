...
* Fixed dependabot issues up to 2026-05-11.

* Fixed safety issues up to 2026-05-11.

* Fixed the tab completion for pywbemlistener which was broken after the fix
  for listing the listeners (same version). (`#1524.2 <https://github.com/pywbem/pywbemtools/issues/1524.2>`_)
...
* For the pywbemcli 'connection' commands, improved the command help texts and
  ...
  not exist. (`#1524 <https://github.com/pywbem/pywbemtools/issues/1524>`_)
...
* Correct documentation formatting errors in the documentation section
  ...
  to match the other tab-activation documentation changes. (`#1524 <https://github.com/pywbem/pywbemtools/issues/1524>`_)
