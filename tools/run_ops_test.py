...
execute_pywbemcli_cmd("class get CIM_ManagedElement --localonly")
execute_pywbemcli_cmd("class get CIM_ManagedElement --no_includequalifiers")
execute_pywbemcli_cmd("class get CIM_ManagedElement -c")
execute_pywbemcli_cmd("class get CIM_ManagedElement --includeclassorigin")
execute_pywbemcli_cmd("class get CIM_ManagedElement --includeclassorigin")
...
execute_pywbemcli_cmd("class enumerate CIM_System --localonly")
execute_pywbemcli_cmd("class enumerate CIM_System --names_only")
